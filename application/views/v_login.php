			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="text-center mt-sm-5 mb-4 text-white-50">
							...
							<p class="mt-3 fs-15 fw-medium">SMA Muhammadiyah 1 Yogyakarta</p>
						</div>
					</div>
				</div>
				<!-- end row -->
				...
				<div class="row justify-content-center">
					<div class="col-md-8 col-lg-6 col-xl-5">
						<div class="card mt-4">
							...
							<div class="card-body p-4">
								<div class="text-center mt-2">
									<h5 class="text-primary">Sign in to continue </h5>
								</div>
								<div class="p-2 mt-4">
						...
						<div class="mt-4 text-center">
							<p class="mb-0">Belum punya account ? <a href="#" class="fw-semibold text-primary text-decoration-underline"> Hub. Panitia </a> </p>
						</div>
					...
					<div class="col-lg-12">
						<div class="text-center">
							<p class="mb-0 text-muted">&copy;
								...
								</script> E-Voting. Developed by Maryanto
							</p>
						</div>
					</div>
				</div>
