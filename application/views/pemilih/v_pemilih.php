                                        ...
                                        <tbody>
                                            ...
                                            foreach ($pemilih as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-soft-warning btn-sm" data-bs-toggle="modal" data-bs-target="#modalEdit<?= $row->ID_PEMILIH ?>">Edit</button>
                                                        <a href="<?= site_url('panitia/pemilih/hapus/' . $row->ID_PEMILIH) ?>" onclick="return confirm('Anda yakin mau menghapus data ini ?')">
...
<div id="modalTambah" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <form method="POST" action="<?= site_url('panitia/pemilih/add') ?>" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-xxl-3 col-md-12">
                        <div>
                            ...
                            <input type="text" class="form-control" name="nm_pemilih" id="basiInput">
                        </div>
                    </div>
...
<?php foreach ($pemilih as $row) { ?>
    <div id="modalEdit<?= $row->ID_PEMILIH ?>" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <form method="POST" action="<?= site_url('panitia/pemilih/update') ?>" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel">Update Data Pemilih</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="col-xxl-3 col-md-12">
                            <div>
                                <label for="basiInput" class="form-label">Nama Lengkap</label>
                                <input type="text" class="form-control" name="nm_pemilih" id="basiInput" value="<?= $row->NM_PEMILIH ?>">
                            </div>
                        </div>
                        ...
                        <input type="hidden" value="<?= $row->ID_PEMILIH ?>" name="id_pemilih" />
                        <!--end col-->
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
